document.addEventListener('DOMContentLoaded', () => {
    ...
    questionsContainer.addEventListener('click', (event) => {
        if (event.target.classList.contains('question-btn')) {
            ...
            document.querySelector(`#question-${questionId} .question-btn[data-answer="yes"]`).style.display = 'none';
            document.querySelector(`#question-${questionId} .question-btn[data-answer="no"]`).style.display = 'none';
        }
